...
export function UnpublishManyDrawerContent(props) {
  ...
  const handleUnpublish = useCallback(async () => {
    await requests.patch(`${serverURL}${api}/${slug}${queryString}`, {
      body: JSON.stringify({
        _status: 'draft'
      }),
      headers: {
  ...
  }, [serverURL, api, slug, queryString, i18n, plural, singular, t, router, searchParams, selectAll, clearRouteCache, addDefaultError, onSuccess]);
