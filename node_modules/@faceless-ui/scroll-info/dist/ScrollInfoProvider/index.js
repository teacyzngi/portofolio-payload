...
export const ScrollInfoProvider = (props) => {
    ...
    const requestAnimation = useCallback((e) => {
    ...
    // }, [requestAnimation]);
    return (React.createElement(ScrollInfoContext.Provider, { value: Object.assign({}, state) }, children && children));
};
